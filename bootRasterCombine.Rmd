...
drive_put(media = file.path(paste0(getwd(),"/meanVarRasters/mean", birdSp,".tif")), 
          path = uploadFolder, 
          name = paste0("mean", birdSp,".tif"), 
          verbose = TRUE)
...
drive_put(media = file.path(paste0(getwd(),"/meanVarRasters/noBootsDF.csv")), 
          path = uploadFolder, 
          name = paste0("noBootsDF.csv"), 
          verbose = TRUE)
...
uploadFolder <- "https://drive.google.com/drive/folders/1fCTr2P-3Bh-7Qh4W0SMJ_mT9rpsKvGEA?usp=sharing"
...
- extra l apply so multiple bird species can be given in bird list at once
- something saying what to do if a BCR or bird sp doesnt exist.
